...
import { createUserRankWithId, createUserRankWithRankName, createUserRankWithOrderNumber } from '../models/userRank.dto';
...
export class UserRankController {
  ...
  @Post()
  async createUserRank(@Body() userRank: createUserRankWithId | createUserRankWithRankName | createUserRankWithOrderNumber) {
